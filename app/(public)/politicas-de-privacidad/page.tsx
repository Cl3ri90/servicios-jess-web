...
export async function generateMetadata(): Promise<Metadata> {
  ...
  return {
    title: `Políticas de Privacidad | ${config?.name || 'Servicios Jess'}`,
    description: `Conoce nuestras políticas de privacidad y protección de datos industriales.`,
  };
}
...
export default async function PrivacyPolicyPage() {
  ...
  const legalContent = config?.legalPrivacy || 'Esta información se encuentra en proceso de actualización por nuestra área legal. Una vez redactado el documento de confidencialidad B2B y políticas de manejo de datos, se desplegará públicamente en esta ruta institucional.';
      ...
      <div className="bg-neutral-900 border-b border-neutral-800 py-32 mb-16 relative overflow-hidden mt-20">
        ...
        <div className="max-w-[1320px] mx-auto px-6 text-center relative z-10">
          ...
          <h1 className="text-4xl md:text-6xl font-black tracking-tight mb-4 text-white uppercase">
            Políticas de <span className="text-[var(--color-primary)]">Privacidad</span>
          </h1>
          <p className="text-xl text-neutral-400 max-w-2xl mx-auto font-light leading-relaxed">
            Protección de datos industriales y compromisos de confidencialidad de {config?.name || 'nuestra empresa'}.
          </p>
        </div>
      </div>
        ...
        <article className="bg-neutral-900/50 border border-neutral-800 p-8 md:p-12 rounded-sm shadow-2xl glass mb-24">
          ...
          <div className="mt-16 pt-8 border-t border-neutral-800 flex flex-col md:flex-row justify-between items-center gap-6">
            <div className="text-xs text-neutral-500 font-mono tracking-widest uppercase">
              CERTIFICACIÓN DE SEGURIDAD ESTRICTA • SINGLE TENANT SYSTEM
            </div>
